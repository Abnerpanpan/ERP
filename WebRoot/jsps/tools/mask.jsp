...
<div id="context-msg" class="context-msg" id="context-msg">
	...
	<div class="content-text content-msg-size content-msg-sizeh content-msg-body">
		...
		<div class="context-msg-btn">
			<center>
			<input id="btn_ok" type="image" src="${pageContext.request.contextPath}/images/content_msg_btn_ok.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input id="btn_cancel" type="image" src="${pageContext.request.contextPath}/images/content_msg_btn_cancel.jpg"/>
			</center>
		</div>
	</div>
